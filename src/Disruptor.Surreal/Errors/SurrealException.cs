...
public class SurrealRpcException : SurrealException
{
    /// <summary>The wire-level error <c>kind</c> string ("Validation", "NotAllowed", "Auth", ...) or null.</summary>
    public string? Kind { get; init; }

    public SurrealRpcException(long code, string message) : base(code, message) { }
}

/// <summary>Authentication failure (signin, authenticate, expired token).</summary>
public class SurrealAuthException : SurrealRpcException
{
    ...
    public SurrealAuthException(long code, string message) : base(code, message) { }
}
...
/// </summary>
public class SurrealConflictException : SurrealRpcException
{
    public SurrealConflictException(long code, string message) : base(code, message) { }
}
...
/// </summary>
public class SurrealTransactionAbortedException : SurrealRpcException
{
    public SurrealTransactionAbortedException(long code, string message) : base(code, message) { }
}
...
/// </summary>
public class SurrealConstraintException : SurrealRpcException
{
    public SurrealConstraintException(long code, string message) : base(code, message) { }
}
