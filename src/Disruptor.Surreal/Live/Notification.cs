...
/// <param name="Record">The affected record id (typically a <see cref="RecordIdValue"/>).</param>
/// <param name="Result">
/// The row payload — current state for <see cref="NotificationAction.Create"/> /
/// <see cref="NotificationAction.Update"/>; before-image for
/// <see cref="NotificationAction.Delete"/>.
/// </param>
