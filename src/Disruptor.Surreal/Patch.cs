...
/// <see cref="Surreal.PatchAsync(string, IEnumerable{SurrealObject}, CancellationToken)"/>
...
public static class Patch
{
    ...
    public static SurrealObject Add(string path, Value value) =>
    ...
    /// <summary>Replace the value at <paramref name="path"/> with <paramref name="value"/>.</summary>
    public static SurrealObject Replace(string path, Value value) =>
    ...
    /// <summary>Assert that the value at <paramref name="path"/> equals <paramref name="value"/>.</summary>
    public static SurrealObject Test(string path, Value value) =>
        new() { ["op"] = "test", ["path"] = path, ["value"] = value };
