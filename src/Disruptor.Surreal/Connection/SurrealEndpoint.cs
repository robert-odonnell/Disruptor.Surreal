...
public enum SurrealEndpointKind
{
...
public sealed record SurrealConnectionConfig
{
...
public sealed record SurrealEndpoint(Uri Url, SurrealEndpointKind Kind, SurrealConnectionConfig Config)
{
    ...
    /// </remarks>
    public static SurrealEndpoint Parse(string url, SurrealConnectionConfig? config = null)
    {
        ArgumentException.ThrowIfNullOrWhiteSpace(url);
        config ??= new SurrealConnectionConfig();
        ...
        {
            "ws" => SurrealEndpointKind.Ws,
            "wss" => SurrealEndpointKind.Wss,
        ...
        return new SurrealEndpoint(uri, kind, config);
    }
}
