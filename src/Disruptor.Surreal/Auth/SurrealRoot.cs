...
public interface ISurrealCredentials
{
...
/// <c>{ "user": ..., "pass": ... }</c>.
/// </summary>
public sealed record SurrealRoot(string Username, string Password) : ISurrealCredentials
{
    /// <inheritdoc />
...
/// need to send it.
/// </remarks>
public sealed class SurrealAccessToken
{
    private readonly string value;

    public SurrealAccessToken(string value)
    {
    ...
    public static implicit operator string(SurrealAccessToken t) => t.value;
}
