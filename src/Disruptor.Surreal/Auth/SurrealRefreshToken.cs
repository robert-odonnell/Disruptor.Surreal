...
/// pattern as <see cref="SurrealAccessToken"/>, same <c>as_insecure_token()</c> escape hatch.
/// </remarks>
public sealed class SurrealRefreshToken
{
    private readonly string value;

    public SurrealRefreshToken(string value)
    {
